...
export const PersonalInfoForm: React.FC<PersonalInfoFormProps> = ({ data, onChange }) => {
  ...
  return (
    <div className="space-y-4 border border-border p-6 bg-card text-foreground shadow-sw-default">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            className="rounded-none border-border focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-primary bg-transparent text-foreground"
          />
        </div>
        <div className="space-y-2">
          <Label
