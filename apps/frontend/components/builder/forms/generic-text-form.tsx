  ...
  return (
    <div className="space-y-2">
      ...
      <Textarea
        ...
        className="min-h-[150px] text-foreground rounded-none border-border focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-primary bg-card"
      />
    </div>
  );
};
