...
export function ResumeUploadDialog({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-md bg-card text-foreground border border-border shadow-sw-lg p-0 gap-0 rounded-none">
        ...
        <div className="p-6 bg-background">
          <div
            className={`
                            ...
                            ${isDragging ? 'border-primary bg-primary/10' : 'border-border hover:border-primary hover:bg-card'}
            ...
            {isUploadingGlobal ? (
              ...
              <div className="flex items-center justify-between gap-4">
                ...
                <Button
                  ...
                  className="hover:bg-destructive/10 text-destructive rounded-none"
              ...
              <div className="flex flex-col items-center py-4">
                <div className="w-12 h-12 border border-border bg-card shadow-sw-default flex items-center justify-center mb-4 text-foreground">
          ...
          {displayErrors.length > 0 && (
            <div className="mt-4 p-3 bg-destructive/10 border border-destructive/30 flex items-start gap-2 text-destructive text-sm">
          ...
          {uploadFeedback?.type === 'success' && (
            <div className="mt-4 p-3 bg-emerald-500/10 border border-emerald-500/30 flex items-center gap-2 text-emerald-600 dark:text-emerald-400 text-sm font-bold">
        ...
        <div className="p-4 border-t border-border bg-secondary flex justify-end gap-2">
          ...
          <DialogClose asChild>
            <Button variant="outline" className="rounded-none border-border hover:bg-muted">
              {t('common.cancel')}
            </Button>
          </DialogClose>
        </div>
